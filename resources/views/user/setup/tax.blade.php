        ...
        <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
            ...
            <div class="page-title d-flex flex-column py-1">
                ...
                <h1 class="d-flex align-items-center my-1">
                    <span class="text-dark fw-bolder fs-1">{{__('messages.tax')}}</span>
                </h1>
                <!--end::Title-->
            </div>
            <!--end::Page title-->
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-contact-table-toolbar="base">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#kt_modal_add_tax">{{__('messages.add_new')}}
                            </button>
                            <!--end::Add customer-->
                        </div>
                        <!--end::Toolbar-->
        ...
        <div class="modal fade" id="kt_modal_add_tax" tabindex="-1" aria-hidden="true" data-backdrop='static'
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    <!--begin::Form-->
                    <form class="form" action="#" id="kt_modal_add_tax_form"
