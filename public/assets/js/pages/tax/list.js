...
var MUBDatatablesServerSide = function () {
                        ...
                        return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-kt-tax-table-filter="edit_row">
                                        Edit
                                    </a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-kt-tax-table-filter="delete_row">
                                        Delete
                                    </a>
                                </div>
                                <!--end::Menu item-->
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = document.querySelectorAll('[data-kt-tax-table-filter="delete_row"]');
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                // Get customer name
                const taxName = parent.querySelectorAll('td')[1].innerText;
                const delete_url = parent.querySelector("input[class='delete_url']").value;

                // SweetAlert2 pop up --- official docs reference: https://sweetalert2.github.io/
                Swal.fire({
                    text: "Are you sure you want to delete " + taxName + "? This is not reversible!",
                    icon: "warning",
    ...
    var handleResetForm = () => {
        // Select reset button
        const resetButton = document.querySelector('[data-kt-tax-table-filter="reset"]');
    ...
    var initToggleToolbar = function () {
        ...
        const container = document.querySelector('#kt_taxes_table');
        const checkboxes = container.querySelectorAll('[type="checkbox"]');

        // Select elements
        const deleteSelected = document.querySelector('[data-kt-tax-table-select="delete_selected"]');
    ...
    var toggleToolbars = function () {
        // Define variables
        const container = document.querySelector('#kt_taxes_table');
        const toolbarBase = document.querySelector('[data-kt-tax-table-toolbar="base"]');
        const toolbarSelected = document.querySelector('[data-kt-tax-table-toolbar="selected"]');
        const selectedCount = document.querySelector('[data-kt-tax-table-select="selected_count"]');
    ...
    var handleUpdateRows = function () {
        // Select all delete buttons
        const editButtons = document.querySelectorAll('[data-kt-tax-table-filter="edit_row"]');
