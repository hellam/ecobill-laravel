            ...
            <div class="card-body pt-0">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_audits_table"
                    ...
                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                        <th class="w-10px pe-2">
                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                <input class="form-check-input" type="checkbox" data-kt-check="true"
                                       data-kt-check-target="#kt_audits_table .form-check-input" value="1"/>
                            </div>
                        </th>
                        ...
                        <th class="text-end min-w-70px">{{__('messages.date')}}</th>
                        <th class="text-end min-w-70px">{{__('messages.narration')}}</th>
                    </tr>
                    <!--end::Table row-->
                    </thead>
                    <!--end::Table head-->
