...
@section('content')
    ...
    <div id="kt_content_container" class="container-xxl">
                                ...
                                <div class="row g-9 mb-7">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <label class="fs-6 fw-bold mb-2 required">
                                            <span>{{__('messages.credit_limit')}}</span>
                                        </label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-solid"
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <select name="sales_account" aria-label="{{__('messages.language')}}"
                                            ...
                                            @foreach($gl_accounts as $gl_account)
                                                <option
                                                    @if(get_all_company_settings()['sales_account'] == $gl_account->account_code)selected
                                                    @endif
                                ...
                                <div class="row g-9 mb-7">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <select name="receivable_account" aria-label="{{__('messages.language')}}"
                                            ...
                                            @foreach($gl_accounts as $gl_account)
                                                <option
                                                    @if(get_all_company_settings()['receivable_account'] == $gl_account->account_code)selected
                                                    @endif
                                                    value="{{$gl_account->account_code}}">{{$gl_account->account_code .' '. $gl_account->account_name}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <select name="sales_discount_account" aria-label="{{__('messages.language')}}"
                                            ...
                                            @foreach($gl_accounts as $gl_account)
                                                <option
                                                    @if(get_all_company_settings()['sales_discount_account'] == $gl_account->account_code)selected
                                                    @endif
                                                    value="{{$gl_account->account_code}}">{{$gl_account->account_code .' '. $gl_account->account_name}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row g-9 mb-7">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <select name="payment_discount_account" aria-label="{{__('messages.language')}}"
                                            ...
                                            @foreach($gl_accounts as $gl_account)
                                                <option
                                                    @if(get_all_company_settings()['payment_discount_account'] == $gl_account->account_code)selected
                                                    @endif
                                                    value="{{$gl_account->account_code}}">{{$gl_account->account_code .' '. $gl_account->account_name}}</option>
                                            @endforeach
                                        </select>
        ...
        <div class="modal fade" id="kt_modal_update_customer_branch" tabindex="-1">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <!--begin::Modal content-->
                <div class="modal-content">
                    ...
                    <!--begin::Form-->
                    <form class="form" action="#" id="kt_modal_update_customer_branch_form"
                          data-kt-action=""
                          data-kt-redirect="">
                        <!--begin::Modal header-->
                        <div class="modal-header" id="kt_modal_update_customer_branch_header">
                            <!--begin::Modal title-->
                            <h2 class="fw-bolder">{{__('messages.update').' '.__('messages.customer').' '.__('messages.branch')}}</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
                            <div id="kt_modal_update_customer_branch_close"
                                 class="btn btn-icon btn-sm btn-active-icon-primary">
                                <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                                <span class="svg-icon svg-icon-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <!--begin::Scroll-->
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_update_customer_branch_scroll"
                                 data-kt-scroll="true"
                                 data-kt-scroll-activate="{default: false, lg: true}"
                                 data-kt-scroll-max-height="auto"
                                 data-kt-scroll-dependencies="#kt_modal_update_customer_branch_header"
                                 data-kt-scroll-wrappers="#kt_modal_update_customer_branch_scroll"
                                 data-kt-scroll-offset="300px">
                                <!--begin::Input group-->
                                <div class="row g-9 mb-7">
                                    <!--begin::Col-->
                        ...
                        <div class="modal-footer flex-center">
                            <!--begin::Button-->
                            <button type="reset" id="kt_modal_update_customer_branch_cancel" class="btn btn-light me-3">
                                Discard
                            </button>
                            <!--end::Button-->
                            <!--begin::Button-->
                            <button type="submit" id="kt_modal_update_customer_branch_submit" class="btn btn-primary">
                                <span class="indicator-label">Submit</span>
                                <span class="indicator-progress">Please wait...
														<span
                                                            class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
