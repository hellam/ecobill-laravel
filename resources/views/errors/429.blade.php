...
<head>
    <base href="../../">
    <title>{{__('messages.error_429')}}</title>
    <meta charset="utf-8"/>
    ...
    </style><!--begin::Theme mode setup on page load-->
        ...
        <div class="d-flex flex-column flex-center text-center p-10">
            ...
            <div class="card card-flush w-lg-650px py-5">
                <div class="card-body py-15 py-lg-20">
                    ...
                    <!--end::Title-->
                    <!--begin::Text-->
                    <div class="fw-semibold fs-6 text-gray-500 mb-7">Too many attempts! Please wait for one minute and
                        try again!
                    </div>
                    <!--end::Text-->
                    <!--begin::Illustration-->
