...
@section('content')
    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <!--begin::Modal - GL Accounts - Update-->
        <div class="modal fade" id="kt_modal_update_gl_account" tabindex="-1">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <!--begin::Modal content-->
                <div class="modal-content">
                    ...
                    <form class="form" action="#" id="kt_modal_update_gl_account_form"
                          data-kt-action="#">
                        <!--begin::Modal header-->
                        <div class="modal-header" id="kt_modal_update_gl_account_header">
                            <!--begin::Modal title-->
                            <h2 class="fw-bolder">{{__('messages.update_gl_account')}}</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
                            <div id="kt_modal_update_gl_account_close"
                                 class="btn btn-icon btn-sm btn-active-icon-primary">
                                <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                                <span class="svg-icon svg-icon-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <!--begin::Scroll-->
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_update_gl_account_scroll"
                                 data-kt-scroll="true"
                                 data-kt-scroll-activate="{default: false, lg: true}"
                                 data-kt-scroll-max-height="auto"
                                 data-kt-scroll-dependencies="#kt_modal_update_gl_account_header"
                                 data-kt-scroll-wrappers="#kt_modal_update_gl_account_scroll"
                                 data-kt-scroll-offset="300px">
                                ...
                                <div class="row g-9 mb-7">
                                    <div class="col-md-12 fv-row">
                                        ...
                                        <select name="account_group"
                                                ...
                                                data-kt-src="#"
                                                data-placeholder="Select Group"
                                                data-dropdown-parent="#kt_modal_update_gl_account"
                                                class="form-select form-select-solid fw-bolder">
                                            <option></option>
                                            @foreach($gl_groups as $group)
                                                <option value="{{$group->id}}">{{$group->name}}</option>
                        ...
                        <div class="modal-footer flex-center">
                            <!--begin::Button-->
                            <button type="reset" id="kt_modal_update_gl_account_cancel" class="btn btn-light me-3">
                                Discard
                            </button>
                            <!--end::Button-->
                            <!--begin::Button-->
                            <button type="submit" id="kt_modal_update_gl_account_submit" class="btn btn-primary">
                                <span class="indicator-label">Submit</span>
                                <span class="indicator-progress">Please wait...
                                <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                            </button>
                            ...
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_gl_group_scroll" data-kt-scroll="true"
                                ...
                                <div class="row g-9 mb-7">
                                    <div class="col-md-12 fv-row">
                                        ...
                                        <label class="fs-6 fw-bold mb-2">
                                            <span
                                                class="required">{{__('messages.group').' '.__('messages.class')}}</span>
                                        </label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
        ...
        <!--begin::Modal - GL Groups - Update-->
        <div class="modal fade" id="kt_modal_update_gl_group" tabindex="-1">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <!--begin::Modal content-->
                <div class="modal-content">
                    ...
                    <form class="form" action="#" id="kt_modal_update_gl_group_form"
                          data-kt-action="#">
                        <!--begin::Modal header-->
                        <div class="modal-header" id="kt_modal_update_gl_group_header">
                            <!--begin::Modal title-->
                            <h2 class="fw-bolder">{{__('messages.update_gl_group')}}</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
                            <div id="kt_modal_update_gl_group_close"
                                 class="btn btn-icon btn-sm btn-active-icon-primary">
                                <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                                <span class="svg-icon svg-icon-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <!--begin::Scroll-->
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_update_gl_group_scroll" data-kt-scroll="true"
                                 data-kt-scroll-activate="{default: false, lg: true}"
                                 data-kt-scroll-max-height="auto"
                                 data-kt-scroll-dependencies="#kt_modal_update_gl_group_header"
                                 data-kt-scroll-wrappers="#kt_modal_add_gl_class_scroll"
                                 data-kt-scroll-offset="300px">
                                ...
                                <div class="row g-9 mb-7">
                                    <div class="col-md-12 fv-row">
                                        ...
                                        <select name="class_id"
                                                ...
                                                data-kt-src="#"
                                                data-placeholder="Select Class"
                                                data-dropdown-parent="#kt_modal_update_gl_group"
                                                class="form-select form-select-solid fw-bolder">
                                            <option></option>
                                            @foreach($gl_classes as $class)
                                                <option value="{{$class->id}}">{{$class->class_name}}</option>
                        ...
                        <div class="modal-footer flex-center">
                            <!--begin::Button-->
                            <button type="reset" id="kt_modal_update_gl_group_cancel" class="btn btn-light me-3">
                                Discard
                            </button>
                            <!--end::Button-->
                            <!--begin::Button-->
                            <button type="submit" id="kt_modal_update_gl_group_submit" class="btn btn-primary">
                                <span class="indicator-label">Submit</span>
                                <span class="indicator-progress">Please wait...
                                <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                            </button>
                ...
                <div class="modal-content">
                    ...
                    <form class="form" action="#" id="kt_modal_update_gl_class_form"
                        ...
                        <div class="modal-header" id="kt_modal_update_gl_class_header">
                            <!--begin::Modal title-->
                            <h2 class="fw-bolder">{{__('messages.update_gl_class')}}</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
...
@push('custom_scripts')
    ...
    <script src="{{ asset('assets/js/pages/gl_maintenance/groups/update.js') }}"></script>
@endpush
