...
<div class="d-flex flex-column flex-root">
    ...
    <div class="page d-flex flex-row flex-column-fluid">
        ...
        <div id="kt_aside" class="aside" data-kt-drawer="true" data-kt-drawer-name="aside"
             ...
             data-kt-branch-details="{{unserialize(session('branch_obj'))}}"
             data-kt-loader="{{asset('assets/media/loaders/loader.gif')}}"
             data-kt-default-currency="{{session('currency')}}">
                    ...
                    <div
                        ...
                        <div class="d-flex align-items-stretch overflow-auto pt-3 pt-lg-0">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Label-->
                                <span
                                    class="fs-7 fw-bold text-gray-700 pe-4 text-nowrap">Switch Branch:</span>
                                <!--end::Label-->
                                <!--begin::Select-->
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="d-flex align-items-center ms-1 ms-lg-3">
                                        <!--begin::Menu- wrapper-->
                                        <div
                                            class="btn btn-icon btn-active-light-primary position-relative btn-custom w-30px h-30px w-md-40px h-md-40px"
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane fade active show" id="kt_topbar_notifications_1"
                                                    ...
                                                    <div class="py-3 text-center border-top">
                                                        <a href="/metronic8/demo2/../demo2/pages/user-profile/activity.html"
                                                ...
                                                <div class="tab-pane fade" id="kt_topbar_notifications_2"
                                                    ...
                                                    <div class="d-flex flex-column px-9">
                                                        ...
                                                        <div class="pt-10 pb-0">
                                                            <!--begin::Title-->
                                                            <h3 class="text-dark text-center fw-bold">Get Pro
                                                                Access</h3>
                                                            <!--end::Title-->
                                                            <!--begin::Text-->
...
<script>
    ...
    function dragElement(elmnt) {
        ...
        if (elmnt.querySelector('.modal-footer')) {
            // if present, the header is where you move the DIV from:
            elmnt.querySelector('.modal-footer').onmousedown = dragMouseDown;
        } else {
            // otherwise, move the DIV from anywhere inside the DIV:
            elmnt.onmousedown = dragMouseDown;
        }
