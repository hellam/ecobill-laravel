                            ...
                            <div class="modal-body py-10 px-lg-17">
                                ...
                                <div class="scroll-y me-n7 pe-7" id="kt_modal_add_product_scroll" data-kt-scroll="true"
                                    ...
                                    <div class="row g-9 mb-7">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            <!--begin::Label-->
                                            <label class="required fs-6 fw-bold mb-2">{{__('messages.product').' '.__('messages.name')}}</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid"
                                    ...
                                    <div class="row g-9 mb-7">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <select name="order" aria-label="{{__('messages.select').' '.__('messages.order')}}"
                                    ...
                                    <div class="row g-9 mb-7">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <select name="taxId" aria-label="{{__('messages.select').' '.__('messages.tax')}}"
                                                    data-control="select2"
                                ...
                                <div class="scroll-y me-n7 pe-7" id="kt_modal_update_product_scroll"
                                    ...
                                    <div class="row g-9 mb-7">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            <!--begin::Label-->
                                            <label class="required fs-6 fw-bold mb-2">{{__('messages.product').' '.__('messages.barcode')}}</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid"
                    ...
                    <div class="modal-content">
                        ...
                        <form class="form" action="#" id="kt_modal_add_category_form"
                            ...
                            <div class="modal-header" id="kt_modal_add_category_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bolder">{{__('messages.new').' '.__('messages.product').' '.__('messages.category')}}</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                                ...
                                <div class="scroll-y me-n7 pe-7" id="kt_modal_add_category_scroll" data-kt-scroll="true"
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <label class="fs-6 fw-bold mb-2" for="group_name">
                                            <span class="required">{{__('messages.category').' '.__('messages.name')}}</span>
                                        </label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                    ...
                                    <div class="row g-9 mb-7">
                                        <div class="col-md-12 fv-row">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-bold mb-2">
                                                <span class="required">{{__('messages.default').' '.__('messages.tax')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <form class="form" action="#" id="kt_modal_update_category_form"
                            ...
                            <div class="modal-body py-10 px-lg-17">
                                <!--begin::Scroll-->
                                <div class="scroll-y me-n7 pe-7" id="kt_modal_update_category_scroll"
                                     data-kt-scroll="true"
                                     data-kt-scroll-activate="{default: false, lg: true}"
                                     data-kt-scroll-max-height="auto"
...
{{--                                                        th:text="${tax.name}"></option>--}}
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <label class="fs-6 fw-bold mb-2"
                                               ...
                                               text="{{__('messages.category').' '.__('messages.description')}}"></label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <textarea id="group_description" class="form-control form-control-solid"
                                                  placeholder="{{__('messages.category').' '.__('messages.description')}}"
                                                  name="description"></textarea>
                                        <!--end::Input-->
                                    </div>
...
@push('custom_scripts')
    <script src="{{asset('assets/js/pages/products/categories/list.js')}}"></script>
    <script src="{{asset('assets/js/pages/products/categories/add.js')}}"></script>
    <script src="{{asset('assets/js/pages/products/categories/update.js')}}"></script>
